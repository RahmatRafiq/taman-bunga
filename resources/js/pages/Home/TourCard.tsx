    ...
    <HoverCard.Root openDelay={200}>
      <HoverCard.Trigger asChild>
        ...
        >
          ...
          <div className="p-6">
            <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100">{tour.name}</h3>
            <p className="mt-2 text-sm text-indigo-500 dark:text-indigo-300 font-medium">{tour.category}</p>
          </div>
        </Link>
      </HoverCard.Trigger>
