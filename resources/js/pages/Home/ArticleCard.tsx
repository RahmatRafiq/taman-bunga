        ...
        <HoverCard.Root openDelay={200}>
            <HoverCard.Trigger asChild>
                <Link
                    ...
                    className="group relative flex flex-col bg-white dark:bg-gray-900 rounded-3xl shadow-lg hover:shadow-2xl transition-shadow duration-300 overflow-hidden border border-gray-100 dark:border-gray-700 hover:border-blue-400 dark:hover:border-blue-500 h-full hover:scale-[1.03] transition-transform"
                >
                            ...
                            {article.tags.slice(0, 3).map((tag) => (
                                <Tooltip.Root key={tag}>
                                    <Tooltip.Trigger asChild>
                                        <span className="px-2 py-0.5 bg-blue-600 dark:bg-blue-400 text-white dark:text-gray-900 text-xs rounded-full shadow cursor-help">
                                            #{tag}
                                        </span>
                                    </Tooltip.Trigger>
                                    <Tooltip.Portal>
                    ...
                    <div className="flex-1 p-6 flex flex-col">
                        ...
                        <p className="mt-2 text-sm text-blue-500 dark:text-blue-300 font-medium">{article.category}</p>
