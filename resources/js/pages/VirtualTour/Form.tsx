...
import { VirtualTour } from '@/types/SphereView';
...
export default function VirtualTourForm({ virtualTour, categories = [] }: Props) {
    ...
    const { data, setData, post, put, processing, errors } = useForm({
        ...
        category_id: virtualTour?.category?.id ?? (categories.length > 0 ? categories[0].id : 1),
    });
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <CustomSelect
                                        ...
                                        onChange={(selected) => {
                                            setData('category_id', (selected as { value: number })?.value ?? (categories.length > 0 ? categories[0].id : 1));
                                        }}
                                    />
