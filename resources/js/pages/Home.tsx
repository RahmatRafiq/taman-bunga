...
export default function Home({ hero, articles, virtualTours }: HomeProps) {
  return (
    <Tooltip.Provider>
      <Head title="Home" />
      {/* Full background gradient wrapper */}
      <div className="min-h-screen w-full bg-gradient-to-b from-white via-indigo-50 to-blue-100 dark:from-indigo-900 dark:via-[#18181b] dark:to-indigo-900">
        <Header />
